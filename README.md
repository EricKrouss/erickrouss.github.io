...
- `src/styles.css`: shared window chrome and palette. `src/desktop.css` arranges the desktop; `src/mobile.css` provides the scrolling phone layout and touch controls.
